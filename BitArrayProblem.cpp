...
// In this HackerRank Bit Array problem in the c++ programming language, 
// You are given four integers: N, S, P, Q. You will use them in order to create the sequence 
// with the following pseudo-code. 

// Your task is to calculate the number of distinct integers in sequence a.
